        ...
        {section.items.map((item, i) => {
          ...
          return (
            <div key={i}>
              ...
              <h3 className="font-body text-lg font-semibold tracking-tight"><LT v={item.title} /></h3>
              <p className="mt-2 text-sm leading-relaxed text-muted"><LT v={item.description} /></p>
            </div>
          );
        })}
      </Stagger>
