...
// BANDA_INFERIOR. Los valores viven en ./margenes.js (modulo hoja) porque el
// prompt de Sofi tambien los lee; aca se re-exportan para no mover a nadie.
...
// La ubicacion (zonasPedidas, zonaCoincide, zonaExcluida, zonaVecina,
// ciudadCoincide, ubicacionCoincide) vive en ./ubicacion.js desde el
// 2026-09-05: es codigo puro que tambien usa redactar.js para no
// reimplementar "misma zona" (ver la nota en ese archivo). Se importa y se
// re-exporta abajo con los mismos nombres.
const {
