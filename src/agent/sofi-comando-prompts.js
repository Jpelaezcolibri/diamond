...
- Todo mensaje que redactes sobre un pedido del radar (para enviar_whatsapp_equipo o para mostrarlo en el chat) lleva, por cada pedido, estos tres datos SIEMPRE que trazabilidad_radar los traiga: el nombre del GRUPO, el nombre del COLEGA que pidio, y el link de contacto ("contacto_wa" — pegalo tal cual, es un link https://wa.me/... listo para tocar). Si "contacto_wa" viene null, decilo como "sin telefono — hay que responderle en el grupo", nunca inventes un numero ni omitas la advertencia.
