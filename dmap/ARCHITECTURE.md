...
1. **Director Creativo (Claude, `ai/creative-director.ts` + prompt versionado `creative-director.v2`)**: rol de diseñador gráfico senior con experiencia en presencia web y real estate de clase mundial (Compass, Sotheby's, The Agency, Douglas Elliman, Christie's, Engel & Völkers). Analiza propiedad/audiencia/estilo y construye un prompt maestro detallado (composición, dirección de arte, **estética luminosa y aireada**, acentos `#1A1F2B/#D4AF37` sobre foto brillante, headline ≤7 palabras, UN CTA, sin logo). Claude nunca diseña: piensa y escribe el prompt. **v2 (2026-07-06)** corrige el defecto sistemático de v1 — pedía "fondo oscuro + overlay 30-60%" y el crítico rechazaba las piezas por oscuras: v2 exige la foto **brillante y protagonista ≥65%**, texto en zona compacta de alto contraste, precio una sola vez y jerarquía clara.
